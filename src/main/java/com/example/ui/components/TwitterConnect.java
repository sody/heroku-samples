 ...
 * from. After twitter authorization this component triggers {@link org.apache.tapestry5.EventConstants#SUCCESS} or
...
public class TwitterConnect extends AbstractComponentEventLink {
     ...
     * @throws java.net.MalformedURLException for incorrect URL produced by twitter service
     */
     ...
     * access was granted then it tries to get OAuth access token and triggers {@link org.apache.tapestry5.EventConstants#SUCCESS} event with
